<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" Inherits="ProCode_DMC_DcmGuide2_qqj" CodeFile="~/ProCode/DCM/DcmGuide2_qqj.aspx.cs" %>
                    ...
                    <div class="MessageList" style="height: 450px">
                        <table>
                            ...
                            <tr style="display: none;">
                                <td align="right" class="TdName">销&nbsp; 售&nbsp; 日&nbsp; 期 ：
                                </td>
                                <td align="left" class="TdValue">
                            ...
                            <tr>
                                <td align="right" class="TdName">发&nbsp;货&nbsp;分&nbsp;店：
                                </td>
                                <td align="left" class="TdValue">
                                ...
                                <tr>
                                    <td align="right" class="TdName">类&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;别：
                                    </td>
                                    <td align="left" class="TdValue">
                                ...
                                <tr>
                                    <td align="right" class="TdName">品&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;牌：
                                    </td>
                                    <td align="left" class="TdValue">
                                ...
                                <tr>
                                    <td align="right" class="TdName">供&nbsp;&nbsp;&nbsp;应&nbsp;&nbsp;&nbsp;商：
                                    </td>
                                    <td align="left" class="TdValue">
                                ...
                                <tr>
                                    <td align="right" class="TdName">拣货数量默认参考值：
                                    </td>
                                    <td align="left" class="TdValue">
                                        <span>
                                            ...
                                            <asp:RadioButtonList ID="rdoCheck" runat="server" AutoPostBack="true" OnSelectedIndexChanged="rdoCheck_SelectedIndexChanged" 
                                                ...
                                                <asp:ListItem Selected="True" Value="1">按分店要货量拣货</asp:ListItem>
                                                <%--qqjMark--%>
                                                <asp:ListItem Value="2" >按分店要货量占比拣货</asp:ListItem>
                                                <%--qqjMark--%>
                                ...
                                <tr>
                                    ...
                                    <td style="color: Blue;">
                                        ...
                                        <span>按分店要货量拣货：根据根据门店要货单的要货数量，直接生成拣货单，而不考虑当前库存量</span><br />
                                        <span>按分店要货量占比拣货：当商品当前库存量小于所选择分店要货量的合计值时，则程序按各分店要货量占要货合计量的比列计算各店分拣量。先计算每个分店要货商品的要货量占总要货量的比例，然后用该比例*库存数量则得出该店的参考分拣数量。即：A店分拣量=（A店要货量/（A+B+…+N店要货量）*库存数量</span><br />
                        ...
                        <table width="100%">
                            <tr>
                                <td>
                                    ...
                                    <%--qqjMark   整个页面都是复制  ~/ProCode/Pur/PurchaseGuide2_qqj.aspx   只是增加了下面的这些而已--%>
                                    <input type="button" value="合并打印" id="btnCombinePrint" class="PtButton" onclick="btnCombinePrint_click()" />
                                    <%-- qqjMark--%>

                                    <script type="text/javascript">

                                        function btnCombinePrint_click() {



                                            var win = window.open('../../QQJFroDL/CombineDYToPrint.aspx?menuId=<%=Request.QueryString["menuId"].Trim()%>' 
                                                + '&needbegindate=' + document.getElementById("ctl00_MPContent_txtBranchDate_txtBeginDate").value
                                                + '&needenddate=' + document.getElementById("ctl00_MPContent_txtBranchDate_txtEndDate").value
                                                + '&branchNo=' + document.getElementById("ctl00_MPContent_txtBranchNo_txtNO").value
                                                + '&itemClsno=' + document.getElementById("ctl00_MPContent_ucItemCls_txtNO").value
                                                + '&itemBrand=' + document.getElementById("ctl00_MPContent_ucItemBrand_txtNO").value
                                                + '&supcustNo=' + document.getElementById("ctl00_MPContent_txtSupNo_txtNO").value
                                                + '&rdoCheck=' + $('#<%=rdoCheck.ClientID %> input[type=radio]:checked').val()

                                                
                                                ,'newwindow', 'top=0,left=0,menubar=no, scrollbars=yes,location=no,resizable=yes');
                                    ...
                                    <asp:Button ID="btnNext" runat="server" Text="下一步" CssClass="PtButton" OnClick="btnNext_Click" Visible="False" />
                                    <%-- qqjMark--%>
